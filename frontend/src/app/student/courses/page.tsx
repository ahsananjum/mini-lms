    ...
    <div className="min-h-[calc(100vh-80px)] bg-surface pt-8 pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
          <div>
            <h1 className="text-3xl font-bold tracking-tight text-on-surface">My Courses</h1>
            <p className="text-slate-500 mt-2 font-medium">Courses you are currently enrolled in.</p>
          </div>
        </div>
