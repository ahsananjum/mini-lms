      ...
      <div className="relative bg-slate-900 border-b border-white/10 pt-16 pb-28 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-4 text-indigo-200/80 font-medium">
             <Link href={`/student/grades`} className="hover:text-white transition-colors">Grades</Link>
             <span>/</span>
             <span className="text-white">Course Grades</span>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-8">
            <div>
               ...
               <h1 className="text-4xl font-extrabold text-white tracking-tight">{courseTitle}</h1>
            </div>
          </div>
        </div>
      </div>
